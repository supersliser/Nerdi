                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Wrap(
                          ...
                          children: [
                            SizedBox(
                              width: appSize.width >= 324 ? 324 : appSize.width - 324,
                              child: Column(
                                children: [
                                        ...
                                        return Column(
                                          children: [
                                            for (int i = 0; i < snapshop.data!.length; i++)
                                              GestureDetector(
                                                onTap: () {
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => InterestPage(interest: data[i])));
                                                },
                                                child: Card.outlined(
                                                    color: data[i].PrimaryColour,
                                                      ...
                                                      children: [
                                                        SizedBox(
                                                          ...
                                                          child: FadeInImage.memoryNetwork(
                                                              fit: BoxFit.cover, placeholder: kTransparentImage, image: data[i].ImageURL),
                                                        ),
                                                        Padding(
